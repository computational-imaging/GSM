    ...
    def forward(
        ...
        **kwargs
        ...
        batch_size = max(betas.shape[0], global_orient.shape[0],
                         body_pose.shape[0])
        if self.v_template.ndim == 3:
            batch_size = max(batch_size, self.v_template.shape[0])
        ...
        vertices, joints, transform_mat, v_posed = lbs(
                betas, full_pose, v_template,
...
class SMPLH(SMPL):
    ...
    def forward(
        ...
        **kwargs
        ...
        vertices, joints, transform_mat, v_posed = lbs(betas, full_pose, self.v_template,
                               self.shapedirs, self.posedirs,
                               self.J_regressor, self.parents,
                               self.lbs_weights, pose2rot=pose2rot)
...
class SMPLX(SMPLH):
    ...
    def forward(
        ...
        **kwargs
        ...
        vertices, joints, transform_mat, v_posed = lbs(shape_components, full_pose, self.v_template,
